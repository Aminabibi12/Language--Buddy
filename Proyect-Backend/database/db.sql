...
values('mdesi98','miguel.desimone98@gmail.com', 'MAD98', 'Miguel Desimone', '1998/04/30', 'male', 'Argentina', 3, 2,'Hello world');
insert into user_info (username, email, password, full_name, date_of_birth , gender , nationality ,language, language_level, description)
values('abubaker', 'habubakernazir@gmail.com', 'ab99', 'Abubaker Nazir', '1997/05/23', 'male', 'Pakistan', 1, 3, 'World Hello');
insert into user_info (username, email, password, full_name, date_of_birth , gender , nationality ,language, language_level, description)
values( 'agafarno','agafarno@gmail.com', 'gaboarno', 'Gabriel Arno', '1981/07/01', 'male', 'Venezuela',2, 4, ' Goodbye world');
